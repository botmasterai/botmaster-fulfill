...
describe('fulfill', () => {
    ...
    describe('Tag attributes and content are passed to the action controller")', () => {
        it('it should return "hi bob" for an input result "<hi>bob</hi> given an action "hi" that uses the content as a name to greet', done => {
            const actions = {
                hi: {
        ...
        it('it should return "hi bob" for an input result "<hi name=bob /> given an action "hi" that uses the attribute name as a name to greet', done => {
            const actions = {
                hi: {
